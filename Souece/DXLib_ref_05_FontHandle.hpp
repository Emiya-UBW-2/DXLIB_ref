...
namespace DXLibRef {
	namespace FontSystem {
		...
		public:
			template <typename... Args>
			void			DrawString(FontSystem::FontXCenter FontX, FontSystem::FontYCenter FontY, int x, int y, unsigned int Color, unsigned int EdgeColor, const std::string& String, Args&&... args) const noexcept {
